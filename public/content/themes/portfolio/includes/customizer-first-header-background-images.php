...
add_action(
    'customize_register',
    'portfolio_first_header_background_images_customizer'
);
...
function portfolio_first_header_background_images_customizer($wpTheme)
{
    ...
    $firstImageBackgroundSelector = new WP_Customize_Image_Control(
