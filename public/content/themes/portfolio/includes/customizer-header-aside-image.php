...
add_action(
    'customize_register',
    'portfolio_header_aside_image_customizer'
);
...
function portfolio_header_aside_image_customizer($wpTheme)
{

    // STEP WP-CUSTOMIZER-02 déclaration de la "section" dans laquelle sera disponible notre customizer

    $wpTheme->add_section(
        'custom-profil-image', // identifiant de la section
    ...
    $imageProfilSelector = new WP_Customize_Image_Control(
